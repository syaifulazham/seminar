          ...
          <div className={styles.subcategories}>
            <div className={styles.subcategory}>
              ...
              <div className={styles.early_bird_container}>
                ...
                Harga Early Bird!! <span className={styles.price}>RM650</span> Sehingga 11 Oktober 2024
        ...
        <div className={styles.categoryCard}>
          ...
          <div className={styles.subcategories}>
            <div className={styles.subcategory}>
              ...
              <div className={styles.early_bird_container}>
                <FaEarlybirds className="text-4xl" />
                Harga Early Bird!! <span className={styles.price}>RM500</span> Sehingga 11 Oktober 2024
