...
export default function VisitorsDashboard() {
    ...
    const renderTotalVisitors = () => (
        <div className="bg-blue-100 p-6 rounded-lg shadow-md text-center flex flex-col items-center justify-center">
    ...
    return (
        <div className="flex flex-col min-h-screen bg-gray-100">
            ...
            <div className="container mx-auto grid grid-cols-4 md:grid-cols-2 lg:grid-cols-4 gap-6 p-4">
